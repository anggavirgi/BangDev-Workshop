...
export const About = () => {
  return (
    <div className="grid grid-cols-2 py-10 gap-10 laptop:gap-0" id="about">
      <div>
        <img
          src={img2}
          alt="cover 2"
          className="lg:w-[400px] laptop:w-[500px] desktop:w-[600px] h-full object-cover"
        />
      </div>
      <div className="flex flex-col py-8">
        ...
        <p className="mt-10 text-lg laptop:pe-20">
        ...
        <div className="mt-8 laptop:mt-16 px-10 grid grid-cols-3 text-center gap-10">
          <div>
            <div className="text-4xl desktop:text-5xl poppins-semibold">
              +100
            </div>
            <hr className="w-1/3 border-4 border-primary mx-auto my-6" />
            <div className="text-2xl desktop:text-3xl font-medium">
              Programmer
            </div>
          </div>
          <div>
